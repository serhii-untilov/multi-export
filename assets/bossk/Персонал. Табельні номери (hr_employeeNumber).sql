...
select people.Num_Tab as ID ,
	...
	cast(cast((case when people.out_date in ('1900-01-01', '2099-01-01') then '9999-12-31' else people.out_date end) as date) as varchar) as dateTo
from PR_CURRENT
...
where PR_CURRENT.Flag_last = '*'
    ...
    and ( (people.out_date = '1900-01-01') or ( people.out_date>='2022-01-01'))
    and (@orgID is null or @orgID = PR_CURRENT.id_Firm)
group by people.Num_Tab, pr_current.id_Firm, people.Auto_Card, INN, Passp_ser, Passp_num, people.out_date
order by employeeID