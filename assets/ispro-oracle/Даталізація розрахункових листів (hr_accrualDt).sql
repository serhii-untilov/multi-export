...
select
    (
        r1.bookmark * 1000 + MOD(coalesce(z1.bookmark, 0), 999)
    ) "ID",
...
,
    case
        when z1.KpuRl_CdSch is not null
        and z1.KpuRl_CdSch > 0 then TO_CHAR (z1.KpuRl_CdSch)
        else ''
    end "accountID"
from /*FIRM_SCHEMA*/ISPRO_8_PROD.kpurlo1 r1
    ...
    left join /*FIRM_SCHEMA*/ISPRO_8_PROD.kpurlospz z1 on z1.kpu_tn = r1.kpu_tn
    and z1.KpuRl_DatRp = r1.KpuRl_DatRp
