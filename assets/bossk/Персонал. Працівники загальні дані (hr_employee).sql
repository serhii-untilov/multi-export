...
select
    ...
    (case when Addr_okrug is null or rtrim(ltrim(Addr_okrug)) = '' then '' else (case when bAddr_City is null or rtrim(ltrim(bAddr_City)) = '' then '' else ', ' end) + Addr_okrug + ' ð-í' end) birthPlace
