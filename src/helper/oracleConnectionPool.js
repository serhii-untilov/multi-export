...
// 2025-06-16 const oracledb = require('oracledb')
...
function initOracleClient(dbConfig) {
    ...
    if (mode === 'thick') {
        ...
        // 2025-06-16 oracledb.initOracleClient(clientOpts) // enable node-oracledb Thick mode
    }
    // 2025-06-16 console.log(oracledb.thin ? 'Running in thin mode' : 'Running in thick mode')
}
