...
class Dictionary {
    ...
    getNextDictProgClassID(code) {
        ...
        const maxID = this.dictProgClass.reduce((a, b) => {
    ...
    getExperienceByName(lastName, firstName, middleName) {
        return this.experienceByName.find(
            (o) =>
                o.lastName.toUpperCase() === lastName.toUpperCase() &&
                o.firstName.toUpperCase() === firstName.toUpperCase() &&
                o.middleName.toUpperCase() === middleName.toUpperCase()
        )
    }

    setDictEducationLevelIDbyName(lastName, firstName, middleName, dictEducationLevelID) {
        this.dictEducationLevelIDbyName.push({
            lastName,
            firstName,
            middleName,
    ...
    getDictEducationLevelIDbyName(lastName, firstName, middleName) {
        return this.dictEducationLevelIDbyName.find(
            (o) =>
                o.lastName.toUpperCase() === lastName.toUpperCase() &&
                o.firstName.toUpperCase() === firstName.toUpperCase() &&
                o.middleName.toUpperCase() === middleName.toUpperCase()
    ...
    getDictTarifCoeffIDbyName(lastName, firstName, middleName) {
        return this.dictTarifCoeffIDbyName.find(
            (o) =>
                o.lastName.toUpperCase() === lastName.toUpperCase() &&
                o.firstName.toUpperCase() === firstName.toUpperCase() &&
                o.middleName.toUpperCase() === middleName.toUpperCase()
