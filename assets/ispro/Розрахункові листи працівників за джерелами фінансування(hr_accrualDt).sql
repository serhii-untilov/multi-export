...
select 
	...
	,cast(CONVERT(DECIMAL(19, 0), z1.KpuRlSPZ_Sm) / 100 as varchar) paySum	
	...
	,case when z1.KpuRl_CdSch > 0 then cast(z1.KpuRl_CdSch as varchar) else '' end accountID
from kpurlo1 r1
inner join kpurlospz z1 on z1.kpu_tn = r1.kpu_tn and z1.KpuRl_DatRp = r1.KpuRl_DatRp and z1.KpuRl_Rcd = r1.KpuRl_Rcd
